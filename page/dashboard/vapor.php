...
SELECT
	...
	SUM(pendapatan) as income,
	SUM(keuntungan) as profit,
	SUM(pengeluaran) as expense,
	SUM(pendapatan-pengeluaran) as margin,
	SUM(pendapatan-keuntungan) as margins
FROM
	laporan
WHERE
	YEAR(tanggal) = '$tahun'
...
echo "<script>window.location.href='http://".$_SERVER['SERVER_NAME']."/vapor/'</script>";
}
?>