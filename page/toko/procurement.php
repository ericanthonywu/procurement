...
<div class="profile">
	<div class="tabbable-line tabbable-full-width">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#app_setting" data-toggle="tab"> App Setting </a>
			</li>
			<li>
				<a href="#order_setting" data-toggle="tab"> Order Setting </a>
			</li>
			<li>
				<a href="#bank_setting" data-toggle="tab"> Bank Setting </a>
			</li>
			<li>
				<a href="#product_setting" data-toggle="tab"> Product Setting </a>
			</li>
			<li>
				<a href="#print_setting" data-toggle="tab"> Print Label Setting </a>
			</li>
			<li>
				<a href="#customer_setting" data-toggle="tab"> Customer Setting </a>
			</li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="app_setting">
				<div class="form-body">
					<div class="row">
						<div class="col-md-8">
							<div class="col-md-6">
							...
							<div class="col-md-8">
								<div class="form-group">
									...
									<textarea type="text" class="form-control" name="email" id="email" required></textarea>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label class="control-label">Aktif Sampai Dengan</label>
									<input type="text" class="form-control" name="email" id="email" required>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
											<?
											if($data_toko['foto']==null OR $data_toko['foto']==""){
											?>
											<img src="<?=$url?>assets/toko/no_image.png" alt="" />
											<?
											}else{
											?>
											<img src="<?=$url?>assets/toko/<?=$data_toko['foto']?>" alt="" />
											<?
											}
											?>
											</div>
									...
									<div class="clearfix margin-top-10">
										...
										<span> Format Gambar Berupa JPG, PNG, JPEG </span>
									</div>
								</div>
							</div>
							<!--/span-->
