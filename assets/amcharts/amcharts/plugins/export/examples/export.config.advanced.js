    ...
    menu: [ {
      ...
      click: function() {
        ...
        this.toJPG( {}, function( data ) {
          this.download( data, "image/jpg", "Chart-Iuran-optical.jpg" );
        } );
      }
    }, {
      label: "PNG",
      click: function() {
        ...
        this.toPNG( {}, function( data ) {
          this.download( data, "image/png", "Chart-Iuran-optical.png" );
        } );
      }
    }, {
      label: "PDF",
      click: function() {
        ...
        this.toPDF( {}, function( data ) {
          this.download( data, "application/pdf", "Chart-Iuran-optical.pdf" );
        } );
      }
    }, {
      label: "SVG",
      click: function() {
        ...
        this.toSVG( {}, function( data ) {
          this.download( data, "text/xml", "Chart-Iuran-optical.svg" );
        } );
      }
    } ]
  } ]
        ...
        menu: [ {
          ...
          click: function() {
            this.toCSV( {}, function( data ) {
              this.download( data, "text/plain", "Chart-Iuran-optical.csv" );
            } );
          }
        }, {
          label: "JSON",
          click: function() {
            this.toJSON( {}, function( data ) {
              this.download( data, "text/plain", "Chart-Iuran-optical.json" );
            } );
          }
        }, {
          label: "XLSX",
          click: function() {
            this.toXLSX( {}, function( data ) {
              this.download( data, "application/octet-stream", "Chart-Iuran-optical.xlsx" );
            } );
          }
        } ]
      }
